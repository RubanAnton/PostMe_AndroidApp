...
import com.example.antonruban.postme.Adapter.AllUserAdapter;
...
public class AllUsersActivity extends AppCompatActivity {
    ...
    private List<ListUserItem> listItems;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recycleAllUser);
        ...
        try {
            ...
            if (my != null) {
                ...
                for (int i = 0; i < jsonarray.length(); i++) {
                    ...
                    ListUserItem listItem = new ListUserItem(Login);
                    listItems.add(listItem);
                    //Log.d("This is login ", Login + " " + Post);
                }
                adapter = new AllUserAdapter(listItems,this);
    ...
    class GetPost extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            HttpGet request = new HttpGet(HOST + "UC/users");
